STATUSES_START
    ...
    STATUSES_ADD_INFO(XENUS_STATUS_OKAY_PE_DATA_DIR_NOT_PRESENT, kStatusOkayPEDataDirNotPresent),
    ...
    STATUSES_ADD_ERROR(XENUS_ERROR_NOT_IMEPLEMENTED, kErrorNotImeplemented),
...
//	STATUSES_ADD_ERROR(XENUS_ERROR_LIBX_, KerrorLibX),
    ...
    STATUSES_ADD_ERROR(XENUS_ERROR_CHAIN_ALREADY_PRESENT, kErrorChainAlreadyPresent),
...
STATUSES_DBG_START
    ...
    STATUSES_DBG_ADD(XENUS_STATUS_OKAY_PE_INCOMPLETE_IAT, kErrorOkayPEIncompleteIAT)
    STATUSES_DBG_ADD(XENUS_STATUS_OKAY_PE_COMPAT_PROBLEM_MAYBE, kErrorOkayPECompatProblem)
    ...
    STATUSES_DBG_ADD(XENUS_ERROR_NOT_IMEPLEMENTED, kErrorNotImeplemented)
    ...
    STATUSES_DBG_ADD(XENUS_ERROR_CHAIN_ALREADY_PRESENT, kErrorChainAlreadyPresent)
