...
XENUS_IMPORT int	default_wake_function(wait_queue_entry_t *curr, unsigned mode, int wake_flags, void *key);
...
XENUS_IMPORT int	__cond_resched_lock(spinlock_t *lock);
